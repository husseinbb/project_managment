                  ...
                  <tbody>
                    {this.state.list.map(function (item, i) {
                      return (
                        <React.Fragment>
                          <tr key={i}>
                            <td key={i}><Link to={{pathname:"/showproject",state: {data :item.id}}} className="atd">{item.name}</Link></td>
                            <td key={i + 1}><Link to="/showproject" className="atd">{item.deadline}</Link></td>
                          </tr>
                        </React.Fragment>
                      );
                    })}
